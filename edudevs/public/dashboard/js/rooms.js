$(function() {
    ...
    function setupChannel(name) {
      ...
      {
        alert("hi man");
        roomChannel.then(function(channel) {
            print(
              `Joined channel ${name} as <span class="me"> ${username} </span>.`,
              true
            );
    ...
    function createOrJoinChannel(channels) {
      ...
      chatClient
        ...
        .then(function(channel) {
          ...
          console.log("hey")
          console.log("room channel is" + roomChannel);
          ...
          else
          {
            ...
            // document.getElementById("messages").innerHTML = "";
            setInterval(doSomething, 8000);
            // channel.getMessages(300).then(processPage);
          }
        //   channel.members.create(data.identity)
          // 
